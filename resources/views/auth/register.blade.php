        ...
        <div class="w-1/2 mx-auto mt-10 p-3">
            <div class="grid grid-cols-2 gap-4">
                ...
                <x-mary-input label="Apellido" wire:model="apellido" name="apellido" placeholder="Ingresa tus apellido"
                    icon="o-user" hint="Tus apellidos completos" />
            </div><br>

            <div class="grid gap-8">
                <x-mary-input label="Correo electrónico institucional" id="email" name="email"
                    placeholder="Tu parte del correo" prefix="" suffix="@cdjuarez.tecnm.mx" />

                <x-mary-input label="Matrícula" id="matricula" name="matricula" placeholder="Ingresa tu matrícula" />

                <x-mary-password label="Contraseña" id="password" name="password" right />
