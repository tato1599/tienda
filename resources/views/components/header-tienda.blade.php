                        ...
                        <div class="flex items-center flex-1 gap-4">
                            ...
                            <form class="flex-1 hidden max-w-lg lg:block">
                                <div class="flex -space-x-0.5">
                                    ...
                                    <button id="categoriesDropdownButton3" data-dropdown-toggle="categoriesDropdown3"
                                        class="z-10 flex-shrink-0 inline-flex items-center py-2 px-3 text-sm font-medium text-center text-gray-900 bg-gray-100 border border-gray-300 rounded-s-lg hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600"
                                        type="button">
                                        All categories
                                        <svg class="w-4 h-4 ms-2 -me-0.5" aria-hidden="true"
                                    ...
                                    <div id="categoriesDropdown3"
                                        class="z-50 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-48 dark:bg-gray-700">
                                    ...
                                    <div class="relative w-full">
                                        <input type="search" id="search-dropdown"
                                            ...
                                            placeholder="What can we help you find today?" required />
                                        <button type="submit"
                        ...
                        <div class="flex items-center justify-end lg:space-x-2">
                            <div class="relative md:hidden">
                                <button type="button" data-collapse-toggle="ecommerce-navbar-search-4"
                                    class="inline-flex items-center justify-center rounded-lg p-2 text-gray-900 dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <span class="sr-only">
                                        Search
                                    </span>
    ...
    ">
                            ...
                            <div>
                                <button id="accountDropdownButton3" data-dropdown-toggle="accountDropdown3"
                                    type="button"
                                    class="inline-flex items-center rounded-lg justify-center p-2 hover:bg-gray-100 dark:hover:bg-gray-700 text-sm font-medium leading-none text-gray-900 dark:text-white">
                                    <img class="w-6 h-6 rounded-full sm:me-1.5"
                                ...
                                <div id="accountDropdown3"
                                    ...
                                    <ul class="p-2 text-start text-sm font-medium text-gray-900 dark:text-white">
                                        ...
                                        <li>
                                            <a href="#" title=""
                                                class="group inline-flex w-full items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-gray-100 dark:hover:bg-gray-600">
                                                <img class="h-4 w-4 shrink-0" src="/images/logo.svg"
                                                    alt="" />
                                                Flowbite
                                                <span
                                                    class="me-2 ml-auto rounded bg-primary-100 px-2.5 py-0.5 text-xs font-medium uppercase text-primary-800 dark:bg-primary-900 dark:text-primary-300">
                                                    Pro </span>
                                            </a>
                                        </li>
                                        <li>
